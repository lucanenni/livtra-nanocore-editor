...
export const cab: BlockSpec = {
  ...
  commonParams: [
    ...
    range('level', 67, 0, 100, {
      default: 70,
      note: 'CC67 Cab Level appears in the MIDI guide CC map but not in the manual\'s common-parameter list; range 0-100 is assumed. See MIDI_MAPPING_NOTES.md.',
    }),
  ],
  types,
};
